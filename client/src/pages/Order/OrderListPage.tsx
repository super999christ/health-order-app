            ...
            <tbody className="divide-y divide-gray-200">
              {orders.map((order: any, index: number) => (
                <tr key={order.orderID} className='text-gray-900 even:bg-gray-50'>
                  <td className="whitespace-nowrap text-center px-3 py-4 text-sm pl-0">{index + 1}</td>
                  ...
                  <td className="whitespace-nowrap text-center px-3 py-4 text-sm pl-0">{order.orderedBy}</td>
                  <td className="whitespace-nowrap text-center px-3 py-4 text-sm">{order.requestedItem}</td>
                  <td className="whitespace-nowrap text-center px-3 py-4 text-sm">{order.createdDate}</td>
                  <td className="whitespace-nowrap text-center px-3 py-4 text-sm flex gap-1 justify-center">
                    <div onClick={() => onCancelOrder()} className="text-red-600 hover:text-red-500 hover:underline cursor-pointer">
                      Cancel
                    </div>
                  </td>
                </tr>
